(() => {
  ...
  if(!['ours','flat','cascade'].includes(focusSystem)||!Object.prototype.hasOwnProperty.call(criterionNames,focusCriterion)){focusSystem=null;focusCriterion=null;}
  ...
  function inputText(sample){return direction==='a2s'?sample.audio_caption:sample.speech_text;}
